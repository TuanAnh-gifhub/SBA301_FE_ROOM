...
const RegisterPage = ({ isOpen, onClose, onSwitchToLogin }: RegisterPageProps) => {
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="relative bg-gradient-to-br from-[#4da6ff] to-blue-500 px-5 py-3.5 text-white">
            ...
            {/* Title */}
            <h2 className="text-xl font-bold text-center mb-1">Tạo Tài Khoản</h2>
            <p className="text-center text-white/90 text-xs">Đăng ký để bắt đầu</p>
          </div>
          ...
          <div className="px-5 py-3">
            <form onSubmit={handleSubmit} className="space-y-2.5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs bg-gray-100 border border-gray-200 rounded-lg text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#4da6ff] focus:border-transparent"
                  required
                />
              </div>
            ...
            <div className="mt-2.5 text-center">
              <span className="text-xs text-gray-700">Đã có tài khoản? </span>
              <button
